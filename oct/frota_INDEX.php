  ...
  <header class="page-header">
    ...
    <div class="right-wrapper pull-right" style='margin-right:15px;'>
      <ol class="breadcrumbs">
        ...
        <li><span class='text-muted'>Frota de veículos</span></li>
      </ol>
                    ...
                    <?
                        ...
                        if(pg_num_rows($res))
                        {
                          ...
                          echo "<thead><tr>
                                  ...
                                  <th><small><i>Placa</i></small></td>
                                  <th><small><i>Apelido</i></small></th>
                                  <th><small><i>Tipo</i></small></th>
                                  <th><small><i>Fabricante</i></small></th>
                                  <th><small><i>Modelo</i></small></th>
                                  <th><small><i>Status</i></small></th>
                          ...
                          while($d=pg_fetch_assoc($res))
                          {
                            ...
                            echo "<td nowrap>".$d['plate']."</td>";
                            echo "<td nowrap>".$d['nickname']."</td>";
                            echo "<td nowrap>".$d['type']."</td>";
                            echo "<td>".$d['brand']."</td>";
                            echo "<td nowrap>".$d['model']."</td>";
                            echo "<td nowrap>".($d['active']=='t'?'Ativo':'Inativo')."</td>";
                            echo "<td class='text-center'>";
                            if(check_perm("3_19","U"))
                            {
                              echo "<a href='oct/frota_FORM.php?id=".$d['id']."'><button class='btn btn-xs btn-default text-muted'><i class='fa fa-cogs'></i></button></a>";
                            }
                            echo "</td>";
                            echo "</tr>";
                          }
                          ...
                          if($filtro)
                          {
                            ...
                            echo "<div class='alert alert-warning text-center'>Não há veículos cadastrados.</div>";
                          }
                        }
