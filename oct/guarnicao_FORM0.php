...
<? if($dados['id'] != ""){ ?>
                      ...
                      <div class="col-sm-6">
                        ...
                        <div class="row">
                         ...
                         <div class="col-sm-2 text-right" style="margin-top:27px">
                       ...
                       <div class="row" style="margin-top:10px">
                                    ...
                                    foreach ($veic_assoc as $tipo => $veics) {
                                      for($i = 0; $i < count($veics); $i++)
                                      {
                                        ...
                                        echo "<tr>";
                                            ...
                                            echo "<td width='80px' class='text-right'>
                                                  <a href='oct/guarnicao_SQL.php?id_garrison=".$id_garrison."&id_workshift=".$id_workshift."&id=".$v['id']."&acao=remover_veiculo'>
                                                  <button style='margin-right:0px' type='button' class='btn btn-sm btn-danger'><i class='fa fa-trash'></i></button>
                                                  </a>
                                            </td>";
                                        echo "</tr>";
                                      }
                          ...
                          <div class="row">
                           ...
                           <div class="col-sm-2" style="margin-top:27px">
                              <button id="bt_add_pass" class="btn  btn-sm btn-primary"><i class="fa fa-user"></i><sup> <i class="fa fa-plus"></i></sup></button>
                          </div>
                         </div>
