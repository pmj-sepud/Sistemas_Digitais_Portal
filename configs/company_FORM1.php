            ...
            <div class="col-md-12 col-lg-12">
              ...
              <div class="tabs">
                <ul class="nav nav-tabs tabs-primary">
                  <li class="<?=$nav_dados;?>">
                    <a href="#dados_cadastrais" data-toggle="tab" ajax='false'>Dados Cadastrais</a>
                  </li>
                  <li class="<?=$nav_trab;?>">
                    <a href="#setores" data-toggle="tab" ajax='false'>Setores</a>
                  </li>
                  <li class="<?=$nav_acess;?>">
                    <a href="#usuarios" data-toggle="tab" ajax='false'>Usuários</a>
                  </li>
                ...
                <div class="tab-content">
                            <div id="dados_cadastrais" class="tab-pane active">
                              <div class="row">
                              ...
                              <form autocomplete="off" id="userform" name="userform" class="form-horizontal" method="post" action="configs/company_SQL.php" debug='0'>
                                ...
                                <fieldset class="mb-xl">
                                  ...
                                  <div class="form-group">
                                    <label class="col-md-4 control-label" for="active">Externo a PMJ?</label>
                                    <div class="col-md-4">
                        ...
                        <div id="setores" class="tab-pane active">
                          <div class="row">
                            <div class="col-md-6 col-md-offset-3">
                              Setores
                            </div>
