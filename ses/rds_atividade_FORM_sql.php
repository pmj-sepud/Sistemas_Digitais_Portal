...
if($_POST['acao']=="Inserir")
{
    ...
    header("Location: rds_atividade_FORM.php?id_rds={$_POST['id_ses_pncd_registro_diario']}&id={$aux['id']}");
}
...
if($_POST['acao']=="Atualizar")
{
    ...
    $res = pg_query($sql)or die("Error ".__LINE__." - Query:{$sql}");
    header("Location: rds_atividade_FORM.php?id_rds={$_POST['id_ses_pncd_registro_diario']}&id={$_POST['id']}");
}
echo "</div>";
