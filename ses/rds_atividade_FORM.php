  ...
  <header class="page-header">
    ...
    <div class="right-wrapper pull-right" style='margin-right:15px;'>
      <ol class="breadcrumbs">
        ...
        <li><a href='ses/registro_diario_servico.php'>Registro diário de serviço</a></li>
        <li><a href='ses/registro_diario_servico_FORM.php?id=<?=$d['id_ses_pncd_registro_diario'];?>'>Vis. detalhada</a></li>
        <li><span class='#'>Atividade</span></li>
      </ol>
    </div>
  </header>
  ...
  <section class="panel box_shadow">
  		<header class="panel-heading" style="height:70px">
            <div class="panel-actions" style="margin-top:5px">
              <a href="ses/rds_FORM.php?id=<?=$d['id_ses_pncd_registro_diario'];?>&tab=tab1">
...
<div class="panel-body">
      <div class="row">
          <div class="col-md-12">
            ...
            <form action="ses/rds_atividade_FORM_sql.php" method="post">
