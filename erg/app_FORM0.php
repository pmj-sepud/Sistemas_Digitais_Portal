                       ...
                       <div class="col-xs-6" id='div_placa'>
                           <div class="form-group">
                            ...
                            <? if($_SESSION['id']!=1){?>
                             ...
                             <? }else{ ?>
                                  <div id="placa_mercosul_div" style="display:none">
                                  <input placeholder="ABC" type="text"   id="plate_m_part0" name="plate_m_part0" class="text-center pl_merc" value="" />
                                  <input placeholder="X"   type="tel"    id="plate_m_part1" name="plate_m_part1" class="text-center pl_merc" value="" />
                                  <input placeholder="A"   type="text"   id="plate_m_part2" name="plate_m_part2" class="text-center pl_merc" value="" />
                                  <input placeholder="XX"  type="tel"    id="plate_m_part3" name="plate_m_part3" class="text-center pl_merc" value="" />
                                  </div>
                             <? } ?>
                          </div>
                        </div>
