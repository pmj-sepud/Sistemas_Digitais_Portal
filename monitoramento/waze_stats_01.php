      ...
      <?
            $sql = "SELECT
                  ...
                  FROM
                      	waze.data_files
                  WHERE
                      	    start_time AT TIME ZONE '0' BETWEEN '".$agora['datasrv']." 00:00:00' AND '".$agora['datasrv']." 11:59:59'
...
<? if($agora['hora']<=11){ ?>
  ...
  <div class="col-sm-6" align="center">
      <span><i>Somatória dos congestionamentos</i></span><br>
      <span style="font-size:35px;">Pico da manhã:</span>
...
<? }else{ ?>
  <div class="col-sm-6 offset-3" align="center">
      <span><i>Somatória dos congestionamentos</i></span><br>
      <span style="font-size:35px;">Pico da manhã:</span>
      <span style="font-size:80px"><b><?=$maxlenght;?> <sup><small>Km</small></sup></b></span>
      <br>Hora: <?=$maxlenghtTime;?>
